...
- **Name is required and unique**: Store has no duplicate names for order statuses
...
- `update_order_statuses_updated_at`: Updates `updated_at` column before UPDATE operations
