...
Lookup table for delivery methods.
...
- **Name is required and unique**: Store has no duplicate names for delivery methods
...
- `update_delivery_methods_updated_at`: Updates `updated_at` column before UPDATE operations
